export const zhTw = {
  ...
  social: {
    ...
    xiaohongshuIconAlt: '小紅書',
    xiaohongshuQrAlt: '小紅書 QR Code',
  ...
  about: {
    ...
    channelsLabel: '頻道',
    xiaohongshuChannel: '懶豆子｜智能家居',
    tiktokChannel: '懶豆子智能家居',
    youtubeChannel: '懶豆子智能家居',
    youtubeDesc: '真實安裝影片、導覽與智能家居技巧——預約前先看看我們怎麼做。',
    tiktokDesc: '短影片、快速示範與懶豆子智能家居靈感。',
    contactLabel: '聯繫我們',
  },
  contact: {
    heroTitle: '免費獲取費用估算。',
    ...
    directContactSub: '選擇你習慣的聯絡方式，我們就能直接開始。',
  },
  cases: {
    heroTitle: '客戶案例',
  ...
  gallery: {
    heroTitle: '展示',
    heroSub: '先看靈感，再由我們為你規劃最適合的智能家居方案。',
  },
  services: {
    heroTitle: '找到適合您家的服務。',
